...
var d=function(e){Object(n["a"])(t,e)
function t(){Object(l["a"])(this,t)
return Object(i["a"])(this,Object(_["a"])(t).apply(this,arguments))}Object(a["a"])(t,[{key:"render",value:function(){return s.a.createElement(k["a"],Object.assign({},this.props,{name:"IconBlueprint",viewBox:"0 0 1920 1920"}),u)}}])
...
return c["default"].get("/api/v1/courses/".concat(t.id,"/blueprint_templates/default/migrations"))},beginMigration(e){let t=e.masterCourse,o=e.willSendNotification,l=e.willIncludeCustomNotificationMessage,a=e.notificationMessage,i=e.willIncludeCourseSettings,_=e.willPublishCourses
...
return c["default"].get("/api/v1/courses/".concat(o.id,"/").concat(a,"/").concat(_,"/migrations/").concat(n))},getMigrationDetails(e,t){let o=e.course
let l=t.blueprintType,a=void 0===l?"blueprint_templates":l,i=t.templateId,_=void 0===i?"default":i,n=t.changeId
return c["default"].get("/api/v1/courses/".concat(o.id,"/").concat(a,"/").concat(_,"/migrations/").concat(n,"/details"))},getFullMigration(e,t){let o=e.course
...
//# sourceMappingURL=48-c-8dbf931950.js.map